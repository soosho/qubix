...
/** Utility functions used by the Qubix Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "qubix:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load qubix specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a qubix specific theme is activated (light/dark).*/
