...
//! Interface for the src/evo part of a qubix node (qubixd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a qubix node (qubixd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a qubix node (qubixd process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a qubix node (qubixd process).
class Node
{
public:
    virtual ~Node() {}
