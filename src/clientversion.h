...
#error Client version information missing: version is not defined by qubix-config.h or in any other way
#endif
...
/**
 * qubixd-res.rc includes this file, but it cannot cope with real c++ code.
