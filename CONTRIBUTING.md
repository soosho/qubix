Contributing to Qubix Core
============================

The Qubix Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/qubixchain/qubix/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Qubix Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Qubix
Network Protocol consensus changes.

Whether a pull request is merged into Qubix Core rests with the project merge
...
Patches that change Qubix consensus rules are considerably more involved than
...
Where a patch set proposes to change the Qubix consensus, it must have been
...
The review process is normally fairly responsive on the Qubix Core repository, however
...
The project leader is the release manager for each Qubix Core release.
