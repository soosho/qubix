...
When deployed on testnet, it is required to start with a fresh data directory or call Qubix Core with `-reindex-chainstate`.

0.12.3.4 Change log
===================

See detailed [set of changes](https://github.com/raptor3um/qubix/compare/v0.12.3.3...qubix:v0.12.3.4).
