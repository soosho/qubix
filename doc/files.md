...
* qubix.conf: contains configuration settings for qubixd or qubix-qt
* qubixd.pid: stores the process id of qubixd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by qubixd or qubix-qt
