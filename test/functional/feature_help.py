...
"""Verify that starting qubixd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start qubixd with -h for help text")
        ...
        self.log.info("Start qubixd with -version for version information")
