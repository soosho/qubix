...
from test_framework.test_framework import QubixTestFramework
...
class LLMQChainLocksTest(QubixTestFramework):
    def set_test_params(self):
        self.set_qubix_test_params(6, 5, fast_dip3_enforcement=True)
