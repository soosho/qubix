...
rm -f src/config/qubix-config.h
...
rm -rf test_bitcoin.coverage/ qubix-gtest.coverage/ total.coverage/
...
clean_exe src/qubix-cli
clean_exe src/qubixd
clean_exe src/qubix-gtest
clean_exe src/qubix-tx
clean_exe src/test/test_qubix
clean_exe src/test/test_qubix_fuzzy
...
clean_dep . src/config/qubix-config.h.in
